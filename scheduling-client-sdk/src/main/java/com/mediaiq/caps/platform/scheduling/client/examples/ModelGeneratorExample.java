...
import com.mediaiq.caps.platform.scheduling.client.model.Executor;
import com.mediaiq.caps.platform.scheduling.client.model.HttpConfig;
import com.mediaiq.caps.platform.scheduling.client.model.HttpConfigBody;
import com.mediaiq.caps.platform.scheduling.client.model.Schedule;
...
public class ModelGeneratorExample {
  ...
  public ScheduleTask getCreateScheduleTask() {
    ...
    return ScheduleTask.builder().creator("akashsrivastava@miqdigital.com")
