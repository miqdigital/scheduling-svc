...
import static com.miqdigital.scheduling.client.constants.ErrorMessage.FAILED_API_CALL_ERROR_MESSAGE;
import static com.miqdigital.scheduling.client.constants.ErrorMessage.SCHEDULE_ID_NULL_ERROR_MESSAGE;
...
import com.miqdigital.scheduling.client.utils.ResponseProcessor;
  ...
  private OkHttpClient getOkHttpClient(SchedulingConfig schedulingConfig) {
    ...
    httpClient.addInterceptor(chain -> {
      ...
      Request request = original.newBuilder().method(original.method(), original.body()).headers(
              original.headers().newBuilder().add("Authorization", authorizationKey).build())
          .build();
